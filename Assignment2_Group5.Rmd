...
```
As can be seen, the sleep quality levels of 4 and 5 are not predicted in the tree. Besides, a sleep quality of 9 is in almost all cases good predicted. And the sleep quality of 7 is in most cases bad predicted (for instance in 43% of the cases, a 4 is the true data, but classified as a 7.)
...
## Acknowledgement 
Sadly, after all our analyses, we found out that the data is synthetic and created by the author for illustrative purposes. However, data is synthetisch :((((
